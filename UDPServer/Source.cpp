...
int main(int argc, char **argv)
{
	...
	char* buffer = (char*)calloc(1,BUFFER_SIZE);			/* Where to store received data */
	...
	while (1)
	{
		...
		/* Check for time request */
			...
			if (sendto(sd, buffer, strlen(buffer)+1, 0, (struct sockaddr *)&client, client_length) != strlen(buffer)+1)
			{
